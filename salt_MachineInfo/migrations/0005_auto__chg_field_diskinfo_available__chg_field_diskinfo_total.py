...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DiskInfo.available'
        db.alter_column(u'salt_MachineInfo_diskinfo', 'available', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'DiskInfo.total'
        db.alter_column(u'salt_MachineInfo_diskinfo', 'total', self.gf('django.db.models.fields.BigIntegerField')())

    def backwards(self, orm):

        # Changing field 'DiskInfo.available'
        db.alter_column(u'salt_MachineInfo_diskinfo', 'available', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'DiskInfo.total'
        db.alter_column(u'salt_MachineInfo_diskinfo', 'total', self.gf('django.db.models.fields.IntegerField')())
